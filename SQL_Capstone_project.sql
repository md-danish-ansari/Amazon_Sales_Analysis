...
SELECT
    (SELECT COUNT(*)
     ...
     WHERE table_name = 'amazon') AS column_count,
    COUNT(*) AS row_count
FROM amazon;
...
Select
	...
	SUM(CASE WHEN vat IS NULL THEN 1 ELSE 0 END) AS vat_null_count,
	...
	SUM(CASE WHEN "gross margin percentage" IS NULL THEN 1 ELSE 0 END) AS gross_margin_null_count,
